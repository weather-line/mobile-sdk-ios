...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      ///
      /// Locales: en, de, uk
      static func johnsPineapplesCount(v1_pineapples_count value1: UInt, preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          let format = NSLocalizedString("johns pineapples count", bundle: hostingBundle, comment: "")
          return String(format: format, locale: applicationLocale, value1)
        }

        guard let (locale, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "johns pineapples count"
        }

        let format = NSLocalizedString("johns pineapples count", bundle: bundle, comment: "")
      ...
      ///
      /// Locales: en, de, uk
      static func lu_completed_runs(lu_completed_runs value1: UInt, lu_total_runs value2: UInt, preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          let format = NSLocalizedString("lu_completed_runs", bundle: hostingBundle, comment: "")
          return String(format: format, locale: applicationLocale, value1, value2)
        }

        guard let (locale, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "lu_completed_runs"
        }

        let format = NSLocalizedString("lu_completed_runs", bundle: bundle, comment: "")
